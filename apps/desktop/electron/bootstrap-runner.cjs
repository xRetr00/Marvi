 ...
 *
 * Drives apps/desktop's first-launch install of Marvi Agent by spawning
...
function downloadInstallScript(commit, destPath) {
  ...
  const url = `https://raw.githubusercontent.com/xRetr00/Marvi/${commit}/scripts/${scriptName}`
