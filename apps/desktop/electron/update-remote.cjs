 ...
 *
 * A public install can end up with `origin=git@github.com:xRetr00/Marvi.git`.
...
const OFFICIAL_REPO_HTTPS_URL = 'https://github.com/xRetr00/Marvi'
const OFFICIAL_REPO_CANONICAL = 'github.com/xretr00/marvi'
