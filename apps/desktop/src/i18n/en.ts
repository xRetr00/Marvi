...
export const en: Translations = {
  ...
  settings: {
    ...
    toolsets: {
      ...
      ready: 'Ready',
      nousIncluded: 'Included with a subscription — sign in to provider portal to activate.',
  ...
  updates: {
    ...
    guiSkewTitle: 'Update your desktop app',
    guiSkewBody:
      'The backend was updated but this desktop app bundle was not. Update or reinstall the Marvi desktop app (your AppImage / .deb / .rpm / installer) to stay in sync.',
    copy: 'Copy',
    copied: 'Copied',
    done: 'Done',
