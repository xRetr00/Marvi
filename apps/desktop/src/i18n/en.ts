...
export const en: Translations = {
  ...
  notifications: {
    ...
    backendOutOfDateMessage:
      'Your Marvi backend is older than this desktop build and may not work correctly. Update to align them.',
    ...
    errors: {
      ...
      methodNotAllowed:
        'The desktop backend rejected that request (405 Method Not Allowed). Try restarting Marvi Desktop.',
    ...
    native: {
      ...
      inputBody: 'Marvi is waiting for your response.',
      turnDoneTitle: 'Marvi finished',
  ...
  settings: {
    ...
    notifications: {
      ...
      focusedHint: 'Completion alerts only fire while Marvi is in the background.',
      kinds: {
        approval: {
    ...
    appearance: {
      ...
      reactionsDesc: 'iMessage-style emoji tapbacks — react to messages, and Marvi can react to yours.',
    ...
    quickEntry: {
      ...
      enabledDesc:
        'Summon a small composer from anywhere with a global shortcut and fire a prompt without opening Marvi.',
    ...
    gateway: {
      ...
      intro:
        'Marvi Desktop starts its own local gateway by default. Use a remote gateway when you want this app to control an already-running Marvi backend on another machine or behind a trusted proxy. Pick a profile below to give it its own remote host.',
      ...
      localDesc: 'Start a private Marvi backend on localhost. This is the default and works offline.',
      ...
      cloudSignIn: 'Sign in to Marvi Cloud',
      cloudSignedIn: 'Signed in to Marvi Cloud',
      cloudNeedsSignIn: 'Sign in to Marvi Cloud to discover the agents on your account.',
      ...
      cloudDiscoverFailed: 'Could not load your Marvi Cloud agents',
      cloudConnectFailed: 'Could not connect to that agent',
      cloudSignInFailed: 'Marvi Cloud sign-in failed',
      cloudSignedOutTitle: 'Signed out of Marvi Cloud',
      cloudSignedOutMessage: 'Cleared the Marvi Cloud session.',
      ...
      remoteUrlDesc: 'Base URL for the remote dashboard backend. Path prefixes are supported, for example /marvi.',
      ...
      restartingMessage: 'Marvi Desktop will reconnect using the saved settings — the shell stays open.',
      ...
      sshDesc:
        'Marvi is launched on the remote over SSH and tunneled to this app — nothing to start or expose yourself. Requires working key-based SSH access to the host.',
      ...
      sshHermesPathTitle: 'Marvi path (optional)',
      sshHermesPathDesc: 'Full path to the remote Marvi binary. Blank = auto-detect.',
      ...
      sshReachable: (host, platform) => `Reachable: ${host} (${platform}) — Marvi found`,
      ...
      sshErrAuth:
        'SSH authentication failed. Load your key into the ssh-agent (ssh-add) or set an IdentityFile in ~/.ssh/config — Marvi runs ssh non-interactively.',
      sshErrHostKey:
        'The host key has CHANGED since you last connected. Verify this is expected, then run ssh-keygen -R <host> and reconnect.',
      sshErrNotInstalled:
        'Marvi is not installed on the remote host. Install it there (curl -fsSL https://raw.githubusercontent.com/xRetr00/Marvi/main/scripts/install.sh | sh) or set the Marvi path.',
      sshErrPlatform:
        'Unsupported remote platform. Marvi Desktop SSH mode supports Linux, macOS, and Windows remote hosts.',
      sshErrTimeout: 'SSH connection timed out. The host may be unreachable or asleep.',
      sshErrUpdateRequired: 'Update Marvi on the remote host before connecting with Desktop SSH.',
    ...
    providers: {
      ...
      localEndpoint: {
        ...
        description: 'Point Marvi at any OpenAI-compatible endpoint (Zyphra, vLLM, llama.cpp, Ollama, etc).'
      },
  ...
  skills: {
    ...
    skillArchivedMessage: 'Restorable via marvi curator restore.',
    hub: {
  ...
  starmap: {
    ...
    emptyDesc: 'As Marvi builds skills and memories for your work, they appear here.',
    share: 'Share map',
    shareHint:
  ...
  messaging: {
    ...
    fieldCopy: {
      ...
      MATRIX_USER_ID: { label: 'Bot user ID', placeholder: '@marvi:example.org' },
  ...
  composer: {
    ...
    placeholderFollowUp: 'Send Marvi a follow-up',
  ...
  updates: {
    ...
    availableBody: 'A new version of Marvi is ready to install.',
    availableTitleBackend: 'Backend update available',
    availableBodyBackend: 'A newer version of the connected Marvi backend is ready to install.',
  ...
  install: {
    ...
    installLocalTitle: 'Install Marvi locally',
    installLocalDesc: 'Download Marvi, create its Python environment, and run the backend on this computer.',
    localStartUnavailable: 'Local installation could not start. Restart Marvi Desktop and try again.',
    remoteSetupTitle: 'Connect to existing Marvi',
    remoteSetupDesc: 'Enter your gateway URL. Marvi Desktop will detect whether it needs a token or browser sign-in.',
    remoteUrlTitle: 'Gateway URL',
    remoteUrlDesc: 'Use the base URL of the Marvi gateway, including https:// when remote.',
    remoteUrlPlaceholder: 'https://gateway.example.com/marvi',
    probing: 'Detecting gateway authentication...',
    probeError: 'Could not reach that Marvi gateway.',
    identityProvider: 'your identity provider',
    authTitle: 'Authentication',
  ...
  shell: {
    ...
    statusbar: {
      ...
      connectionCloudTooltip: host => `Marvi Cloud · ${host}`,
  ...
  preview: {
    ...
    web: {
      ...
      finishedRestarting: message => `Marvi finished restarting the preview server${message ? `: ${message}` : ''}`,
      ...
      restartFailedMessage: 'Marvi could not restart the server.',
      stillWorking:
        'Marvi is still working, but no restart result has arrived yet. The server command may be running in the foreground.',
  ...
  assistant: {
    thread: {
      ...
      loadingResponse: 'Marvi is loading a response',
    ...
    approval: {
      gatewayDisconnected: 'Marvi gateway is not connected',
  ...
  desktop: {
    ...
    restartToUseSaveImage: 'Restart Marvi Desktop to use Save Image.',
    restartToSaveImages: 'Restart Marvi Desktop to save images',
    ...
    handoff: {
      ...
      timedOut: 'Timed out waiting for the gateway. Is `marvi gateway` running?'
    }
  },
