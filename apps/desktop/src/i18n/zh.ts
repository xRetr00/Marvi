...
export const zh: Translations = {
  ...
  settings: {
    ...
    toolsets: {
      ...
      ready: '就绪',
      nousIncluded: '包含在 订阅中；登录 provider portal 即可激活。',
  ...
  messaging: {
    ...
    platformIntro: {
      ...
      bluebubbles: '在装有 iMessage 的 Mac 上运行 BlueBubbles Server，暴露其 API，然后用服务器密码把 Marvi 指向该 URL。',
  ...
  modelPicker: {
    ...
    pro: 'Pro',
    proNeedsSubscription: 'Pro 模型需要付费 订阅。',
    free: '免费',
    freeTier: '免费层',
