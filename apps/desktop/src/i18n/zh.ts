...
export const zh: Translations = {
  ...
  notifications: {
    ...
    voice: {
      ...
      streamingFallback: '流式语音转写不可用，已回退到录音转写。',
      streamingUnavailable: '流式语音转写不可用。',
  ...
  settings: {
    ...
    quickEntry: {
      ...
      placeholder: '向 Marvi 提问…',
      disconnected: '打开 Marvi 以重新连接',
      sendTo: '发送到',
      currentChat: '当前聊天',
      newSession: '新会话'
    },
    ...
    gateway: {
      ...
      envOverride: '环境变量覆盖',
      intro:
        'Marvi Desktop 默认会启动自己的本地网关。当你希望此应用控制另一台机器上或可信代理后的现有 Hermes 后端时，可以使用远程网关。下面可按 profile 指定各自的远程主机。',
      appliesTo: '应用于',
      ...
      savedTitle: '网关设置已保存',
      restartingMessage: 'Marvi Desktop 将使用已保存设置重新连接（界面保持打开）。',
      ...
      sshErrNotInstalled:
        '远程主机上未安装 Marvi。请在远程安装（curl -fsSL https://raw.githubusercontent.com/xRetr00/Marvi/main/scripts/install.sh | sh）或设置 Marvi 路径。',
      sshErrPlatform: '不支持的远程平台。Marvi Desktop 的 SSH 模式支持 Linux、macOS 和 Windows 远程主机。',
  ...
  mind: {
    ...
    graph: {
      ...
      description: '探索 Marvi 如何关联人物、项目、事实和事件。选择节点即可查看或修改。',
      searchPlaceholder: '搜索或聚焦节点',
      filterLabel: '筛选节点类型',
      allTypes: '所有类型',
      types: {
        person: '人物',
      ...
      unavailable: '后端离线时无法使用图谱。',
      empty: '随着 Marvi 将所学内容建立关联，思维图谱会逐渐形成。',
      canvasLabel: '知识图谱',
      selectHint: '选择节点以查看摘要、来源、连接和可用操作。',
      connections: '连接',
      noConnections: '尚无已记录的连接。',
      connectionsFailed: '无法加载节点连接',
      salience: value => `显著度 ${value}%`,
      source: kind => `来自 ${kind}`,
      edit: '编辑',
      delete: '删除',
      ...
      deleteDescription: '这会从图谱中移除该节点及其连接，但不会更改其来源记忆。'
    },
    composio: {
      title: '已连接应用',
