...
#
# Both Hermes (upstream) and Marvi historical templates are listed so users
# who installed under either name get the seamless upgrade.
_LEGACY_TEMPLATE_SOULS = (
    # --- Hermes-era templates (upstream originals) ---
    (
    ...
    # --- Marvi-era templates (same scaffold, Marvi branding) ---
    (
        "# Marvi Agent Persona\n"
        "\n"
        "<!--\n"
