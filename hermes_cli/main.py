    ...
    fallback_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "connection errors.  See: "
                "https://github.com/xRetr00/Marvi/tree/main/website/docs/user-guide/features/fallback-providers.md"
        ),
    )
    ...
    secrets_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "Secrets Manager and 1Password.  See: "
                "https://github.com/xRetr00/Marvi/tree/main/website/docs/user-guide/secrets"
        ),
    )
    ...
    egress_parser = subparsers.add_parser(
        ...
        description=(
            ...
            "requests leave a sandbox.  Disabled by default.  See: "
                "https://github.com/xRetr00/Marvi/tree/main/website/docs/user-guide/egress/iron-proxy.md"
        ),
    )
