...
def _seed_supervise_skeleton(svc_dir: Path) -> None:
    ...
    def _chown_if_available(path: Path) -> None:
        ...
        try:
            ...
            # Running as the hermes user already — ownership is effectively
            # correct for lifecycle operations in that case.
            pass

    def _make_control(path: Path) -> None:
