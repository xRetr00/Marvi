...
def _build_full_manifest(
    ...
    return {
        ...
        "display_information": {
            "name": bot_name[:35],
            "description": (bot_description or "Your Marvi agent on Slack")[:140],
...
def slack_manifest_command(args) -> int:
    ...
    """
    name = getattr(args, "name", None) or "Marvi"
    description = getattr(args, "description", None) or "Your Marvi agent on Slack"
