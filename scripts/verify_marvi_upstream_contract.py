...
REQUIRED_TEXT = {
    ...
    "plugins/smart_room/runtime/vision/service.py": ["class VisionService", "def _face_loop"],
    "plugins/smart_room/runtime/vision/faces.py": ["class FaceLibrary", "def add_pending"],
