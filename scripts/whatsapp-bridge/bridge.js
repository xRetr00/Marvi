...
const DEFAULT_REPLY_PREFIX = 'M *Marvi Agent*\n────────────\n';
...
async function startSocket() {
  ...
  sock = makeWASocket({
    ...
    browser: ['Marvi Agent', 'Chrome', '120.0'],
  ...
  try {
    ...
    switch (type) {
      ...
      case 'audio': {
        ...
        // If the caller passes mp3, wav, m4a etc. (e.g. from Edge TTS / PocketTTS),
