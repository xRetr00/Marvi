...
def test_build_welcome_banner_title_is_hyperlinked_to_release():
    ...
    tag_url = ("v2026.4.23", "https://github.com/xRetr00/Marvi/releases/tag/v2026.4.23")
    ...
    assert "Marvi Agent v" in raw, "Version label missing from title"

    assert "\x1b]8;" not in raw or "releases/tag/v2026.4.23" in raw
