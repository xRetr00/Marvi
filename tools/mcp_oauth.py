    ...
    mcp_servers:
      my_server:
        ...
        oauth:                                  # all fields optional
          ...
          client_name: "My Custom Client"       # default: "Marvi Agent"
"""
    ...
    async def _redirect_handler(authorization_url: str) -> None:
        ...
        if on_ssh and redirect_uri:
            ...
            print(
                ...
                f"\n"
                f"  See: https://github.com/xRetr00/Marvi\n",
                file=sys.stderr,
            )
...
#   "Claude Code" → 200
#   "Codex"       → 200
    #   "Marvi Agent" / "Marvi" / "Cursor" / "VS Code" / … → 403
...
def _build_client_metadata(cfg: dict) -> "OAuthClientMetadata":
    ...
    client_name = cfg.get("client_name", "Marvi Agent")
