...
export const defaultTheme: DashboardTheme = {
  name: "default",
  label: "Marvi Teal",
  description: "Classic dark teal — the canonical Marvi look",
  palette: {
...
/**
 * Nous Blue — the inverted "light mode" Marvi look, ported from the
...
export const defaultLargeTheme: DashboardTheme = {
  name: "default-large",
  label: "Marvi Teal (Large)",
  description: "Marvi Teal with bigger fonts and roomier spacing",
