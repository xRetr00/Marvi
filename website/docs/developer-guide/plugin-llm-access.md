...
* Implementation: [`agent/plugin_llm.py`](https://github.com/xRetr00/Marvi/blob/main/agent/plugin_llm.py)
* Tests: [`tests/agent/test_plugin_llm.py`](https://github.com/xRetr00/Marvi/blob/main/tests/agent/test_plugin_llm.py)
