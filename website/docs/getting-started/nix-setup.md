...
nix run github:xRetr00/Marvi -- setup
nix run github:xRetr00/Marvi -- chat

# Or install persistently
nix profile install github:xRetr00/Marvi
hermes setup
hermes chat
```
...
```bash
nix profile install github:xRetr00/Marvi#messaging
```

For all optional extras (voice, all providers, all platforms):

```bash
nix profile install github:xRetr00/Marvi#full
```
