...
```bash
# Run the desktop app
nix run github:xRetr00/hermes-agent#desktop

# Or install persistently
nix profile install github:xRetr00/hermes-agent#desktop

# run the tui
nix run github:xRetr00/hermes-agent -- setup
nix run github:xRetr00/hermes-agent -- --tui

# or install it in your profile
nix profile install github:xRetr00/hermes-agent
hermes setup
hermes --tui
```
...
# /etc/nixos/flake.nix (or your system flake)
{
  inputs = {
    ...
    hermes-agent.url = "github:xRetr00/Marvi";
  };
...
```nix
{
  inputs.hermes-agent.url = "github:xRetr00/Marvi";
