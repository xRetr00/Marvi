...
[Download the Marvi Desktop installer](https://github.com/xRetr00/Marvi/releases) for macOS or Windows, then open it. On first launch it finishes setting itself up (usually under a minute).
