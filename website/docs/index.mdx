...
To easily install the command-line and desktop applications, [download the Marvi Desktop installer](https://hermes-agent.nousresearch.com/desktop) from our website and run it.
...
- **Built by model trainers** — Created by [Nous Research](https://nousresearch.com), the lab behind Marvi, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [Nous Research](https://nousresearch.com) — the lab behind Marvi, Nomos, and Psyche models
