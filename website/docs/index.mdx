...
slug: /
sidebar_position: 0
title: "Marvi Agent Documentation"
description: "The self-improving AI agent built by xRetro Labs Research. A built-in learning loop that creates skills from experience, improves them during use, and remembers across sessions."
...
The self-improving AI agent built by [xRetro Labs Research](https://github.com/xRetr00/Marvi). The only agent with a built-in learning loop — it creates skills from experience, improves them during use, nudges itself to persist knowledge, and builds a deepening model of who you are across sessions.
...
>
  ...
  <a
    href="https://github.com/xRetr00/Marvi/blob/main/website/docs/user-guide/desktop.md"
    style={{
      display: "inline-block",
      padding: "0.6rem 1.2rem",
...
To easily install the command-line and desktop applications, [download the Marvi Desktop installer](https://github.com/xRetr00/Marvi/blob/main/website/docs/user-guide/desktop.md) from the repo and run it.

### Without Marvi Desktop:

For a command-line only install without Marvi Desktop, run:
...
| 🔌 **[MCP Integration](/user-guide/features/mcp)**                      | Connect to MCP servers, filter their tools, and extend Marvi safely  |
| 🧭 **[Use MCP with Marvi](/guides/use-mcp-with-hermes)**               | Practical MCP setup patterns, examples, and tutorials                 |
| 🎙️ **[Voice Mode](/user-guide/features/voice-mode)**                    | Real-time voice interaction in CLI, Telegram, Discord, and Discord VC |
| 🗣️ **[Use Voice Mode with Marvi](/guides/use-voice-mode-with-hermes)** | Hands-on setup and usage patterns for Marvi voice workflows          |
| 🎭 **[Personality & SOUL.md](/user-guide/features/personality)**        | Define Marvi' default voice with a global SOUL.md                    |
...
| 💡 **[Tips & Best Practices](/guides/tips)**                            | Quick wins to get the most out of Marvi                              |
...
- **Built by model trainers** — Created by [xRetro Labs Research](https://github.com/xRetr00/Marvi), the lab behind Marvi, Nomos, and Psyche. Works with [Nous Portal](https://portal.nousresearch.com), [OpenRouter](https://openrouter.ai), OpenAI, or any endpoint
...
- **Research-ready** — Batch processing, trajectory export, RL training with Atropos. Built by [xRetro Labs Research](https://github.com/xRetr00/Marvi) — the lab behind Marvi, Nomos, and Psyche models
