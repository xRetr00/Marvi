...
|----------------|----------|
| Config options | `hermes config edit` or [Configuration docs](/docs/user-guide/configuration) |
| Available tools | `hermes tools list` or [Tools reference](/docs/reference/tools-reference) |
| Slash commands | `/help` in session or [Slash commands reference](/docs/reference/slash-commands) |
| Skills catalog | `hermes skills browse` or [Skills catalog](/docs/reference/skills-catalog) |
| Provider setup | `hermes model` or [Providers guide](/docs/integrations/providers) |
| Platform setup | `hermes gateway setup` or [Messaging docs](/docs/user-guide/messaging/) |
| MCP servers | `hermes mcp list` or [MCP guide](/docs/user-guide/features/mcp) |
| Profiles | `hermes profile list` or [Profiles docs](/docs/user-guide/profiles) |
| Cron jobs | `hermes cron list` or [Cron docs](/docs/user-guide/features/cron) |
| Memory | `hermes memory status` or [Memory docs](/docs/user-guide/features/memory) |
| Env variables | `hermes config env-path` or [Env vars reference](/docs/reference/environment-variables) |
| CLI commands | `hermes --help` or [CLI reference](/docs/reference/cli-commands) |
