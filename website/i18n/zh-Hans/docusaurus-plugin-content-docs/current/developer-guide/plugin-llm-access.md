...
* 实现：[`agent/plugin_llm.py`](https://github.com/xRetr00/Marvi/blob/main/agent/plugin_llm.py)

* 测试：[`tests/agent/test_plugin_llm.py`](https://github.com/xRetr00/Marvi/blob/main/tests/agent/test_plugin_llm.py)
