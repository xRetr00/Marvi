...
SITE_BASE = "https://github.com/xRetr00/Marvi"
...
def emit_llms_index() -> str:
    ...
    lines.append("")
    lines.append(
        "> The self-improving AI agent built by xRetro Labs Research. A terminal-native "
    ...
    lines.append("")
    lines.append("Repo: https://github.com/xRetr00/Marvi")
    lines.append("")
...
def emit_llms_full() -> str:
    ...
    chunks: list[str] = [
        ...
        "Canonical site: https://github.com/xRetr00/Marvi\n",
        "Short index: https://github.com/xRetr00/Marvi\n",
        "\n---\n\n",
    ]
