    ...
    <div className={styles.wrap}>
      ...
      <div className={styles.hero}>
        ...
        <p>
          ...
          What the Marvi Agent community is actually building. Every tile
          below links to a real post, issue, video, or gist where someone

          describes how they use Marvi &mdash; scraped from X, GitHub, Reddit,
      ...
      <div className={styles.footer}>
        ...
        Built something with Marvi?{' '}
        <a

          href="https://github.com/xRetr00/Marvi/edit/main/website/src/data/userStories.json"
